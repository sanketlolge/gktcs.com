<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" MasterPageFile="~/FirstSeen.Master"
    Inherits="GKTCS_Official.Home" %>

<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="head">
    <title>Expertise Training on Computer Technologies at GKTCS</title>
    <meta name="description" content="GKTCS Innovations Pvt. Ltd. is one of the best Training Institute and Development Organization in Pune.">
    <meta name="keywords" content="Python Programming Pune, Android Programming Pune, Java Programming Pune, Advance java Programming Pune, PHP Programming Pune, Computer Programming Pune, dotnet Programming Pune, python classes Pune, Android Programming Pune, python online training">
    <meta name="abstract" content="Python in india, Python india, Python courses in india, Python training in india, Python courses in india, Python course in india, Python courses in Pune, Python training in pune, Python course in pune, python beginner course in india, python beginner courses in pune, python beginner course in pune, python beginner courses in pune, python online training, python training, python courses, python programming in india, python programming in pune, python online program in India, python online training program in India, python online training program in pune">
    <meta name="keyphrases" content="Python in india, Python india, Python courses in india, Python training in india, Python courses in india, Python course in india, Python courses in Pune, Python training in pune, Python course in pune, python beginner course in india, python beginner courses in pune, python beginner course in pune, python beginner courses in pune, python online training, python training, python courses, python programming in india, python programming in pune, python online program in India, python online training program in India, python online training program in pune">
    <meta name="author" content="gktcs.com">
    <meta name="copyright" content="gktcs.com">
    <meta name="rating" content="general">
    <%--<meta name="robots" content="index,follow">--%>
    <meta name="identifier-url" content="www.gktcs.com">
    <%--<meta name="googlebot" content="index,follow">--%>
    <meta name="classification" content="GKTCS in India">
    <meta name="owner" content="surendra@gktcs.com">
    ...
    <style type="text/css">
        ...
        #sidebar1, #sidebar2, #sidebar3, #sidebar4, #sidebar5, #div1, #div2, #div3, #div4, #div5
        {
            position: absolute;
        }
    </style>
    ...
    <div id="content" style="margin-left: -40px;">
        <div id="container" style="width: 1150px; height: 245px;">
            <div style="float: left; padding-right: 15px; height: 260px; width: 195px; background-color: #E9E9E9;">
                <ul style="height: 260px; width: 210px; text-align: center;" class="box-list">
                    <li style="margin-left: -40px; margin-top: -12px; width: 210px; height: 260px;"><a
                        style="text-decoration: none;" href="wfrmPythonTech.aspx">
            ...
            <div style="float: left; margin-left: 13px; padding-right: 15px; height: 260px; width: 195px;
                ...
                <ul style="height: 260px; width: 210px; text-align: center;" class="box-list">
                    <li style="margin-left: -40px; margin-top: -12px; width: 210px; height: 260px;"><a
                        style="text-decoration: none;" href="wfrmAndroidTech.aspx">
            ...
            <div style="float: left; margin-left: 13px; padding-right: 15px; height: 260px; width: 195px;
                ...
                <ul style="height: 260px; width: 210px; text-align: center;" class="box-list">
                    <li style="margin-left: -40px; margin-top: -12px; width: 210px; height: 260px;"><a
                        style="text-decoration: none;" href="wfrmJavaTech.aspx">
            ...
            <div style="float: left; margin-left: 13px; padding-right: 15px; height: 260px; width: 195px;
                ...
                <ul style="height: 260px; width: 210px; text-align: center;" class="box-list">
                    <li style="margin-left: -40px; margin-top: -12px; width: 210px; height: 260px;"><a
                        style="text-decoration: none;" href="wfrmPHPTech.aspx">
                        ...
                        <div id="sidebar">
                            <ul class="spy">
                                <li><a href="#" title="View round">
                                    <%--<img width="70" height="70" src="../images/Placed Students/ShashankVerma.jpg" title="" />--%>
                                    </a>
                                    <h5>
